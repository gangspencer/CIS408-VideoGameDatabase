...
var perform_request = function(url, resolve, reject){
  ...
  var options = {
    ...
    headers: {
      ...
      'X-Mashape-Key': process.env.mashapeKey || global.mashapeKey || 'dQtO1a7QyJmshSrJmUrkPain3Wayp1xZKREjsnNbLrTzbTK52Q' //Od0UAN8Yv5mshjdZcrIHtVoDYFBCp1EK4ZLjsnaiKAOgkStI4x
    }
  };
